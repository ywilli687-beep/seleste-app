...
export default function SignUpPage() {
  return (
    <div style={{
      ...
      backgroundImage: 'radial-gradient(circle at top left, rgba(200,169,110,0.05), transparent 400px), radial-gradient(circle at bottom right, rgba(200,169,110,0.03), transparent 400px)',
      padding: '2rem',
      position: 'relative',
      overflow: 'hidden',
