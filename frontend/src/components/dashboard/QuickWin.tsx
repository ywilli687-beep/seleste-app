      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            <Tooltip text="This is the one fix that will have the biggest positive impact on your score right now. We pick it based on what's missing and how much it matters.">
              <span className="text-small" style={{ color: 'var(--green2)' }}>BEST THING TO FIX NOW</span>
            </Tooltip>
